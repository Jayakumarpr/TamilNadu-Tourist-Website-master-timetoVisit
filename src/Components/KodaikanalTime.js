      ...
      <Modal.Dialog className='modalCardsize'>
        ...
        <div className='imgbox'>
            <div className='imgcardtag' >
               <img src={require("../Gallery/kodaikanal1.jpeg")} className='modalcard' /> 
               <p >
            ...
            <div className='imgcardtag' >
               <img src={require("..//Gallery/kodaikanal2.jpeg")} className='modalcard' /> 
               <p >
                 {/* Chennai <br/> */}
                 Kodaikkanal Lake <br/>
                 source
            ...
            <div className='imgcardtag' >
               <img src={require("..//Gallery/kodaikanal3.jpeg")} className='modalcard' /> 
               <p >
